...
interface EditProfileModalProps {
  ...
  setEditProfileCodeStyle: (val: CodeStylePreset) => void;
...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({
  isOpen, onClose, editingProfile, editProfileName, setEditProfileName,
  editProfileDesc, setEditProfileDesc,
  editProfileCodeStyle, setEditProfileCodeStyle, editProfileCustomTemplate,
  setEditProfileCustomTemplate, handleSaveEditProfile
}) => {
                ...
                {CODE_STYLE_PRESETS.map((preset) => {
                  ...
                  return (
                    <button
                      key={preset.id}
                      type="button"
                      onClick={() => setEditProfileCodeStyle(preset.id as CodeStylePreset)}

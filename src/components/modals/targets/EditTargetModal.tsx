  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm p-2 sm:p-3 flex justify-center items-center">
      <div className="bg-[#1E1E20] border border-[#3A3A3E] rounded-xl sm:rounded-2xl max-w-md w-full shadow-2xl flex flex-col max-h-[85dvh] sm:max-h-[82vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Modal Header */}
        <div className="p-2.5 sm:p-3 border-b border-[#2D2D30] shrink-0 flex items-center justify-between">
          <div className="flex items-center gap-1.5 min-w-0">
            <h3 className="text-xs sm:text-sm font-semibold text-[#E2E2E4] flex items-center gap-1.5 truncate">
            ...
            {activeProfile && activeProfile.items.length > 1 && (
              <div className="flex items-center gap-0.5 bg-[#141416] px-1 py-0.5 rounded-lg border border-[#353538]">
                ...
                <button
                  ...
                  className="p-0.5 hover:bg-[#262629] text-[#8E8E93] hover:text-white rounded transition-colors"

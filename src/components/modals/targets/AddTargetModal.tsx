...
import { Plus, X, Sparkles, EyeOff, Eye, ChevronDown, Target } from 'lucide-react';
      ...
      <div className="bg-[#1E1E20] border border-[#3A3A3E] rounded-xl sm:rounded-2xl max-w-md w-full shadow-2xl flex flex-col max-h-[85dvh] sm:max-h-[82vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-3 sm:p-4 border-b border-[#2D2D30] shrink-0 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs sm:text-sm font-bold text-[#E2E2E4]">Add Target</h3>
              <p className="text-[10px] text-[#8E8E93] flex items-center gap-1">
                <span>Profile:</span>
                <span className="text-indigo-300 font-semibold">{activeProfile?.name || 'Active Profile'}</span>
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-2.5 sm:p-3.5 flex-1 overflow-y-auto space-y-2.5 sm:space-y-3 overscroll-contain pr-1.5">
          {/* Alert Banner */}
          <div className="flex items-center gap-2 p-2 sm:p-2.5 rounded-xl border border-indigo-500/30 bg-indigo-950/20 text-indigo-200 text-xs">
            <Target className="w-3.5 h-3.5 shrink-0 text-indigo-400" />
            <span className="text-[11px] leading-tight">
              Create a new target for <strong className="text-white font-semibold">{activeProfile?.name}</strong>.
            </span>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2 p-0.5 sm:p-1 bg-[#141416] border border-[#353538] rounded-lg sm:rounded-xl">
              <button
                type="button"
